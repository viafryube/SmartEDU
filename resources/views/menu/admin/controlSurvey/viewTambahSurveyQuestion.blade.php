...
@section('container')
    ...
    <div class="ps-4 pe-4 mt-4  pt-4">
        <h2 class="display-6 fw-bold"><a href="{{ route('viewSurveyQuestions') }}"><button type="button"
                    ...
                    <i class="fa-solid fa-arrow-left"></i></button></a> Tambah Pertanyaan</h2>
    </div>
    ...
    <div class="">
        <div class="row p-4">
            <div class="col-12 col-lg-12 bg-white rounded-2">
                <div class="mt-4">
                    <div class="p-4">
                        <form action="{{ route('tambahSurveyQuestion') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="">
                                <button type="submit" class="btn-lg btn btn-primary w-100">Simpan</button>
                            </div>
                        </form>
                    </div>
                </div>

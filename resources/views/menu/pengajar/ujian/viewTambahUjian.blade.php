                            ...
                            <div class="mb-3">
                                ...
                                @if (session()->has('info'))
                                    <input type="text" class="form-control" id="inputName" name="name"
                                        placeholder="Inputkan judul Ujian..." value="{{ old('name', session('info')[0]) }}"
                                        required>
                                @else
                                    <input type="text" class="form-control" id="inputName" name="name"
...
<script src="https://cdn.tiny.cloud/1/e966shkvid62orfohcf6p25two1e2ypco5llmtl7xzk0o9g6/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>;    <script src="{{ url('/asset/js/rich-text-editor.js') }}"></script>

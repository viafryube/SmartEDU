        ...
        <div class="row p-4">
            ...
            <div class="col-12 col-lg-12">
                <div class="mt-4 row my-auto mx-auto">
                    <div class="card m-2 col-lg-3 col-md-3 col-12">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Ujian dengan Pilihan Ganda</p>
                    ...
                    <div class="card m-2 col-lg-3 col-md-3 col-12">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Ujian dengan Essay</p>
                            <a href="{{ route('viewCreateUjian', ['token' => encrypt($kelasId), 'type' => 'essay', 'mapelId' => $mapel['id']]) }}"
                                class="w-100 btn btn-primary">Pilih</a>
                        </div>
                    </div>
                    <!-- <div class="card m-2 bg-transparent col-lg-3 col-md-3 col-12">
                        <img src="{{ url('/asset/img/coming_soon.png') }}" class="card-img-top" style="filter: saturate(0);"
                            alt="...">
